    ...
    public static void main(String[] args) {
        ...
        do {
            if(monster.getRemainingHp() != 0) {
                ...
                monster.takeDamage(hero1.getDamage());
                ...
                System.out.println(monster.getName() + "has " + monster.getRemainingHp() + " remaining.");

            }
            if (hero1.heroStatus() || hero2.heroStatus() || hero3.heroStatus() || hero4.heroStatus() || monster.getRemainingHp()!=0) {
                monster.monsterTurn();
                if (monster.getMonsterMove()!=3) {
                    monster.target();
        ...
        } while (hero1.heroStatus() || hero2.heroStatus() || hero3.heroStatus() || hero4.heroStatus() || monster.getRemainingHp()!=0); // this will never exit moster loop. fix it.
    }
}
